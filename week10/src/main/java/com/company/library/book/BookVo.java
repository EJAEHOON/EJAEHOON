...
public class BookVo {
	...
	public String getB_thumnail() {
		return b_thumnail;
	}
	public void setB_thumnail(String b_thumnail) {
		this.b_thumnail = b_thumnail;
	}
	...
	public int getRental_able() {
		return rental_able;
	}
	public void setRental_able(int rental_able) {
